...
class AudioControl(PluginBase):
    ...
    def init_vars(self):
        ...
        self.add_icon(Icons.AUDIO_OFF, self.get_asset_path("audio_off.png"), size)
        self.add_icon(Icons.AUDIO_LOW, self.get_asset_path("audio_low.png"), size)
        self.add_icon(Icons.AUDIO_MEDIUM_LOW, self.get_asset_path("audio_medium_low.png"), size)
        ...
        self.add_icon(Icons.AUDIO_MAX, self.get_asset_path("audio_max.png"), size)
